...
abstract class $LoginStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AsyncValue<void> status});
}
...
class _$LoginStateImpl implements _LoginState {
  const _$LoginStateImpl({this.status = const AsyncValue.data(null)});
...
abstract class _LoginState implements LoginState {
  const factory _LoginState({final AsyncValue<void> status}) = _$LoginStateImpl;
